...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new yeniellandestoy.native_shared_preferences.NativeSharedPreferencesPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin native_shared_preferences, yeniellandestoy.native_shared_preferences.NativeSharedPreferencesPlugin", e);
    }
    try {
