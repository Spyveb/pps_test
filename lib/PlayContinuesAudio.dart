...
class PlayContinuesAudio extends StatefulWidget {
  final List<Subsession>? subsession;
  late int pageValue;
  final bool isContinueStreaming;
  final bool playOnline;

  PlayContinuesAudio(this.subsession, this.pageValue, this.isContinueStreaming,
      this.playOnline);

  @override
  _PlayContinuesAudioState createState() => _PlayContinuesAudioState();
}

bool isFromNoInternetState = false;

class _PlayContinuesAudioState extends State<PlayContinuesAudio> {
  String? fileName = '', uri;
  ...
  loadAudio() async {
    ...
    audioPlayer.onPlayerCompletion.listen((event) async {
      if (widget.isContinueStreaming &&
          widget.subsession!.length - 1 > widget.pageValue) {
        ...
        setState(() {
          if (Navigator.of(context).canPop())
            Navigator.of(context).pop(widget.pageValue);
        });
      }
    });
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        ...
        Navigator.pop(context, widget.pageValue);
            ...
            : Stack(
                children: <Widget>[
                  Center(
                    ...
                    imageUrl: widget.subsession![widget.pageValue].imageUrl!,
                  )),
                  Container(
  ...
  void initializeAudio() {
    ...
    fileName = widget.subsession![widget.pageValue].audioName;
    uri = widget.subsession![widget.pageValue].audioUrl;
